...
We also use an \emph{average-case} signing cost, while the \emph{worst-case} does not significantly increse the number of compressions after signature generation.
...
\midrule
        ...
        Compression per Byte ($\rho$) & $0.303844$ & $0.268663$ & $0.8842\times$ \\
\bottomrule
\end{tabular}
\end{table}
